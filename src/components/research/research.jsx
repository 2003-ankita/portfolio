  ...
  return (
    ...
    >
      <div className="container mx-auto px-5 py-10">
        ...
        <div className="h-full border-2 border-orange-400 shadow-[0_0_15px_rgba(255,165,0,0.7)] border-opacity-60 rounded-lg overflow-hidden flex flex-col md:flex-row items-center justify-between bg-gray-900">
          ...
          <div className="w-full md:w-1/2 flex justify-center p-4">
             <img
               ...
               transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-[0_0_20px_rgba(255,165,0,0.7)]"
               alt="Research Paper"
             />
          </div>
          ...
          <div className="w-full md:w-1/2 p-6 text-center md:text-left">
            ...
            <h2 className="title-font font-bold text-white sm:text-2xl text-xl mb-2">
