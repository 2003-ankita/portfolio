...
export default function Projects() {
    const listProjects = [
        ...
        { 
            ...
            description: 'Scraped YouTube data using the YouTube Data API, extracting metrics like subscribers, views, and comments. The insights were visualized using Seaborn for content analysis.',
