...
export default function Projects() {
    const listProjects = [
        ...
        { 
            ...
            description: 'Scrape and visualize YouTube data using the YouTube Data API, extracting metrics like likes, subscribers, engagement rates, etc. making it a valuable tool for content creators and analysts.',
