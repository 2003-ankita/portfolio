...
export default function Projects() {
    const listProjects = [
        ...
        { 
            ...
            description: 'Scrape, analyze, and visualize YouTube data using the YouTube Data API, extracting metrics like subscribers, views, likes and comments, making it a valuable tool for content creators.',
