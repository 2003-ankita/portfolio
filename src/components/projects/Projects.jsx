...
export default function Projects() {
    const listProjects = [
        ...
        { 
            ...
            description: 'Scraped and analyzed data from YouTube Channel using the YouTube Data API. Visualized trends and patterns using Seaborn for comprehensive channel insights.',
